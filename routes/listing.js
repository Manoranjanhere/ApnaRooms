...
router.route("/")
    ...
    .post(isLoggedIn, upload.array('uploadedImages'),validateListing, wrapAsync(listingController.createListing));
...
router.route("/:id")
    ...
    .put( isLoggedIn, upload.array('listing[image]'),isOwner, wrapAsync(listingController.updateListing))
